...
our $ecc_error_inst_rf_exc;
our $ecc_error_data_exc;
...
our $ECC_ERROR_INST_RF_EXC_ID;
our $ECC_ERROR_DATA_EXC_ID;
our $NUM_EXC_IDS;
...
create_exception_constants
{
    ...
    $constants{ECC_ERROR_INST_RF_EXC_ID} = 25;   # ECC error on inst or RF rd
    $constants{ECC_ERROR_DATA_EXC_ID} = 26;      # ECC error on data access
    $constants{NUM_EXC_IDS} = 27;
    ...
    $constants{ECC_ERROR_INST_RF_CAUSE_CODE} = 18;   # ECC error on inst or RF rd
    $constants{ECC_ERROR_DATA_CAUSE_CODE} = 19;      # ECC error on data access
...
create_exceptions
{
    ...
    $ecc_error_inst_rf_exc = add_exception($exceptions, {
        name        => "ecc_error_inst_rf",
        id          => manditory_int($constants, "ECC_ERROR_INST_RF_EXC_ID"),
        priority    => 9,
        inst_fetch  => 1,
        cause_code  => manditory_int($constants, "ECC_ERROR_INST_RF_CAUSE_CODE"),
    });
    ...
    $ecc_error_data_exc = add_exception($exceptions, {
        name        => "ecc_error_data",
        id          => manditory_int($constants, "ECC_ERROR_DATA_EXC_ID"),
        priority    => 16,
        cause_code  => manditory_int($constants, "ECC_ERROR_DATA_CAUSE_CODE"),
        record_addr => $RECORD_DATA_ADDR,
    });
