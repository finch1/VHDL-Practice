...
#define CC1_SPEC "							\
 ...
 %{tcortex-a8-be8:%{mfloat-abi=softfp:%eCortex-A8 multilib defaults to VFP and NEON}}	\
 %{profile:-p}"
...
#define SUBTARGET_EXTRA_ASM_SPEC \
  "%{tiwmmxt2:-mcpu=iwmmxt2} %{tiwmmxt:-mcpu=iwmmxt} %{txscale:-mcpu=xscale -EB} %{tcortex-a8-be8:-mcpu=cortex-a8 -EB} -meabi=4" 
