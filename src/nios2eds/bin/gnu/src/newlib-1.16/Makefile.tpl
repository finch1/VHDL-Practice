...
AR_FOR_TARGET=$(STAGE_AR_WRAPPER) @AR_FOR_TARGET@
AS_FOR_TARGET=$(STAGE_AS_WRAPPER) @AS_FOR_TARGET@
...
RANLIB_FOR_TARGET=$(STAGE_RANLIB_WRAPPER) @RANLIB_FOR_TARGET@
...
CFLAGS_FOR_TARGET = $(strip -O2 -g $(CFLAGS) $(SYSROOT_CFLAGS_FOR_TARGET) \
	$(DEBUG_PREFIX_CFLAGS_FOR_TARGET))
SYSROOT_CFLAGS_FOR_TARGET = @SYSROOT_CFLAGS_FOR_TARGET@
DEBUG_PREFIX_CFLAGS_FOR_TARGET = @DEBUG_PREFIX_CFLAGS_FOR_TARGET@
CXXFLAGS_FOR_TARGET = $(strip -O2 -g $(CXXFLAGS) $(SYSROOT_CFLAGS_FOR_TARGET) \
	$(DEBUG_PREFIX_CFLAGS_FOR_TARGET))
