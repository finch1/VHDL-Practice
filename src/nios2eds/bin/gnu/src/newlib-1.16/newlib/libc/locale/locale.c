...
/* should not really be using WANT_SMALL_STDIO but its
   two days from code complete and I don't want to define
   a new define now
   
   Long term I want to disable additional locales so that
   these functions "work" but do nothing */
int WANT_SMALL_STDIO_locale_c;
