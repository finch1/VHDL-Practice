...
module nios_ddr_sdram (
	...
	nios_ddr_sdram_controller_phy	nios_ddr_sdram_controller_phy_inst(
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRControllerMVCModel"  active_core="nios_ddr_sdram_controller_phy" >
...
// Retrieval info:      <PRIVATE name = "alt_top" value="nios_ddr_sdram_alt_mem_ddrx_controller_top"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "nativelink_excludes" value="nios_ddr_sdram_phy_alt_mem_phy_seq.vhd,nios_ddr_sdram_phy_alt_mem_phy_seq_wrapper.vhd,nios_ddr_sdram_phy_alt_mem_phy_seq_wrapper.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="nios_ddr_sdram_alt_mem_ddrx_controller_top.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+nios_ddr_sdram_alt_mem_phy_seq_wrapper;+nios_ddr_sdram_alt_mem_phy_reconfig;+nios_ddr_sdram_alt_mem_phy_pll;+nios_ddr_sdram_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\Users\GOKU\AppData\Local\Temp\alt7035_9049521096297214950.dir\0003_iptb_gen/nios_ddr_sdram_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="nios_ddr_sdram_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
