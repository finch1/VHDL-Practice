...
// ============================================================
// Megafunction Name(s):
// 			nios_ddr_sdram_phy_alt_mem_phy
// ============================================================
...
module nios_ddr_sdram_phy (
	...
	nios_ddr_sdram_phy_alt_mem_phy	nios_ddr_sdram_phy_alt_mem_phy_inst(
	...
	defparam
		nios_ddr_sdram_phy_alt_mem_phy_inst.FAMILY = "Cyclone III",
		nios_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_MEMTYPE = "DDR",
		nios_ddr_sdram_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "LOW",
		nios_ddr_sdram_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 12,
		nios_ddr_sdram_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		nios_ddr_sdram_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN2",
		nios_ddr_sdram_phy_alt_mem_phy_inst.DQS_PHASE = 6000,
		nios_ddr_sdram_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 2,
		nios_ddr_sdram_phy_alt_mem_phy_inst.DWIDTH_RATIO = 2,
		nios_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 16,
		nios_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 13,
		nios_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 2,
		nios_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 1,
		nios_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		nios_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 2,
		nios_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		nios_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		nios_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_DQS_WIDTH = 2,
		nios_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_OCT_EN = 0,
		nios_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 1,
		nios_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 10000,
		nios_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "10000 ps",
		nios_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 58,
		nios_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 0,
		nios_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		nios_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		nios_ddr_sdram_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 80,
		nios_ddr_sdram_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		nios_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 0,
		nios_ddr_sdram_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		nios_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		nios_ddr_sdram_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0;
endmodule
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="nios_ddr_sdram_phy_alt_mem_phy" >
...
// Retrieval info:      <PRIVATE name = "mem_btype" value="Interleaved"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "alt_top" value="nios_ddr_sdram_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="nios_ddr_sdram_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+nios_ddr_sdram_phy_alt_mem_phy_seq_wrapper;+nios_ddr_sdram_phy_alt_mem_phy_reconfig;+nios_ddr_sdram_phy_alt_mem_phy_pll;+nios_ddr_sdram_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\Users\GOKU\AppData\Local\Temp\alt7035_9049521096297214950.dir\0003_iptb_gen/nios_ddr_sdram_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="nios_ddr_sdram_phy_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
