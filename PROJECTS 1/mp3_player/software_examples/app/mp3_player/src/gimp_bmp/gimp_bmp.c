...
//      *(unsigned long *)(dest_line_ptr) = *(unsigned long *)(src_line_ptr);
      *(unsigned char *)(dest_line_ptr+0) = *(unsigned char *)(src_line_ptr + 2);
      *(unsigned char *)(dest_line_ptr+1) = *(unsigned char *)(src_line_ptr + 1);
      *(unsigned char *)(dest_line_ptr+2) = *(unsigned char *)(src_line_ptr + 0);
      *(unsigned char *)(dest_line_ptr+3) = *(unsigned char *)(src_line_ptr + 3);
